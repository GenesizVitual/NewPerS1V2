...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Ubah Akun Pemeriksa Provinsi
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <form action="{{ url('ubahAccountInspektorat/'. $data->id) }}" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="provinsi" value="{{ $dataMaster->province_id  }}" readonly>
                        </div>
                        <div class="form-group">
