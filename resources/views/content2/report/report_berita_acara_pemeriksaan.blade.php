    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12" style="padding-bottom: 1%">
            <section class="content-header">
                <h1>
                    Halaman Berita Acara Pemerikaan Persediaan
                </h1>
            </section>
        </div>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Tabel Berita Acara Pemerikaan Persediaan </h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start {{ url('print_laporan_perjenis_barang') }} -->

                            <div class="box-body">
                            <button type="button" onclick="show_report_setting()" class="btn btn-primary"><i class="fa fa-refresh fa-spin" id="loading"></i> Print Berita Acara Pemeriksaan</button>
                                <p></p>
                                <p></p>
                                <table class="table table-bordered table-striped dataTable">
                                    ...
                                    <tr>
                                        <th>No</th>
                                        <th>Jenis Barang</th>
                                        <th>Jumlah Sisa Perjenis Barang</th>
                                    </tr>
                                    </thead>
                                    <tbody>
