...
<body class="legal print-area">
    <section class="sheet padding-10mm">
        ...
        <section class="title">
            <h4>SURAT PERMINTAAN BARANG</h4>
        </section>
        <section class="content">
            <label>
                <h4><span>Nomor</span> <p>: &nbsp; {{ $surat_pengeluaran->no_surat_permintaan }}</p></h4>
                <h4><span>Perihal</span> <p>: &nbsp; {{ $surat_pengeluaran->prihal_surat}}</p></h4>
        ...
        <section class="footer">
            <p>{{ $instansi->getDistrict->district }}, {{ date('d-m-Y', strtotime($surat_pengeluaran->tgl_surat)) }}</p>
            <table>
                <tr height="35px">
                    <td>
                        @if(!empty($ttd1))
                ...
                <tr>
                    <td>
                        <h3 class="hr">( {{ $surat_pengeluaran->get_kepala_bidang->nama_berwenang }} )</h3>
                        <h3>NIP. {{ $surat_pengeluaran->get_kepala_bidang->nip }}</h3>
                    </td>
                    <td>
