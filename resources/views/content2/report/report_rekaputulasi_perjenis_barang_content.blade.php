    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12" style="padding-bottom: 1%">
            <section class="content-header">
                <h1>
                    Halaman Laporan Rekapitulasi Penerimaan Perjenis Barang
                </h1>
            </section>
        </div>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> Laporan Rekapitulasi Penerimaan Perjenis Barang</h3>
                        </div>
                        <!-- /.box-header -->
