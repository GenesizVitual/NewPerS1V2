    ...
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
           <section class="content-header">
                <h1>
                    Halaman membuat berita acara penerimaan hasil pekerjaan pengadaan barang
                </h1>
            </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form berita acara penerimaan hasil pekerjaan pengadaan barang</h3>
                    </div>
                    <div class="box-body">
                        <form action="{{ url('buat_nota_berita_hasil_pekerjaan/store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2 select2-hidden-accessible" required style="width: 100%;" tabindex="-1" aria-hidden="true"  name="nota_id">
                                        ...
                                        @foreach($data_surat_pesanan as $vaitem)
                                            <option value="{{ $vaitem->id }}"> {{ $vaitem->nomor_surat}} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" required name="no_berita_acara" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="username">Nomor Surat Keputusan</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" required name="no_keputusan" >
                                </div>
                            </div>
                           <div class="form-group">
                                <label class="col-md-2 control-label" for="username">Tanggal Surat Keputusan</label>
                                <div class="col-md-9">
                                    <input type="text" id="datepicker2" class="form-control" required name="tgl_surat_keputusan"  data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                                </div>
                            </div>
                            <div class="form-group">
