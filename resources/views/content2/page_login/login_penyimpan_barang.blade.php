...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/') }}"><b>Selamat Datang Di Aplikasi Manajemen Persediaan</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ url('/') }}" method="post">
            ...
            <div class="row">
                <div class="col-xs-5">
                    <a href="{{ url('ganti_password') }}" class="btn btn-danger btn-block btn-flat">Lupa password</a>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('signup') }}" class="text-center">Mendaftar</a>
        <a href="{{ url('signup_admin') }}" class="text-center pull-right">Masuk Sebagai Admin</a>
