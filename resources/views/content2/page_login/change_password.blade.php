...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/') }}"><b>Halaman Ganti password</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ url('shadow_password') }}" method="post">
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="email" placeholder="email">
                <label style="color: red">Password Bayangan Akan dikirimkan ke email anda</label>
            </div>
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-4">
