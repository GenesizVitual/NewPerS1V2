        ...
        <section class="content">
            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ url('suppliers/'.$suppliers->id.'/edit') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="pimpinan" name="pimpinan" value="{{ $suppliers->pimpinan }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="suppliers">Alamat</label>
                                <div class="col-md-8">
                                    <textarea class="form-control"  name="alamat">{{ $suppliers->alamat }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="suppliers">No.Kontak</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="no_kontak" value="{{ $suppliers->no_kontak_supplier }}">
                                </div>
                            </div>
