        ...
        <section class="content">
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form action="{{ url('StoreletterofExpenditure') }}" method="post">
                        {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="prihal"> Pengeluaran Barang </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Pengurus Barang</label>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#ambil_barang').click(function () {
                $.ajax({
                    url:'{{ url('expendures_bidang_pengeluaran') }}',
                    dataType: 'json',
                    type: "post",
                    data:{
                        '_token' : '{{ csrf_token() }}',
