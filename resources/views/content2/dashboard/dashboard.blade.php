            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Silahkan mengisi pengaturan awal pada masing masing sub menu pengaturan awal
                    </div>
                    @endif
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
               <!---{{Session::get('status_aktif') }}-->
                    <div class="info-box">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            @if(!empty($total_pengeluaran))
                                <span class="info-box-number">{{ number_format($total_pengeluaran,2,',','.') }}</span>
                            @else
