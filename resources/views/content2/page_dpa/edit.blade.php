        ...
        <section class="content">
            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="{{ url('editDpa/'.$data->id.'/edit') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true"  name="fiscal_id">
                                        ...
                                        @foreach($thn_anggaran as $vaitem)
                                            <option value="{{ $vaitem->id }}" @if($vaitem->id== $data->fiscal_years_id) selected @endif> {{ $vaitem->years}} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="nilai_anggaran" value="{{ $data->pagu_value }}">
                                </div>
                            </div>
