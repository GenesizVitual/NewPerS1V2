        ...
        <section class="content">
            ...
            <!-- Default box -->
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Tambah Kabupaten</h3>
                ...
                <form action="{{ url('storekabupaten') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true"  name="provinsi">
                                    ...
                                    @foreach($provinsi as $vaitem)
                                        <option value="{{ $vaitem->id }}"> {{ $vaitem->province}} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
