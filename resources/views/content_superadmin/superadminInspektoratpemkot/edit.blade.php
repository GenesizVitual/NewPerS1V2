...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Edit Admin Inspektorat Pemkot
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Edit Admin Inspektorat Pemkot</h3>
                ...
                <form action="{{ url('ubahaccountsuperadmininspektoratpemkot/'.$data->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
