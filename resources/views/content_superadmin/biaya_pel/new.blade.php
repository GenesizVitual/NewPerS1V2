...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Tambah Biaya Pelatihan
            </h1>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <form action="{{ url('store_biaya_pel') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="datepicker" class="form-control" name="tanggal_bayar_duluan" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="username">Besaran Cashback</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="besaran_cashback">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="username">Biaya Normal</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="jumlah_biaya">
                                    </div>
                                </div>
                                {{ csrf_field() }}
                                <div class="form-group">
