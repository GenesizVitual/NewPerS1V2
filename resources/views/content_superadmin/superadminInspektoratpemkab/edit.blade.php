...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Edit Admin Inspektorat Kabupaten
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Edit Admin Inspektorat Kabupten</h3>
                ...
                <form action="{{ url('ubahaccountsuperadminInspektoratpemkab/'.$data->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">

                        <div class="form-group">
                            <label class="col-md-3 control-label" for="username">Nama Pengguna</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="username" value="{{ $data->account }}">
                            </div>
                        </div>
                        <div class="form-group">
