...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Tambah Admin Inspektorat Kabupaten
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Tambah Admin Inspektorat Kabupaten</h3>
                ...
                <form action="{{ url('tambahaccountsuperadminInspektoratpemkab') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
