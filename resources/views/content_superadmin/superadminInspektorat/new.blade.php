...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Halaman Tambah Pemeriksa Inspektorat
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Tambah Pemeriksa Inspektorat</h3>
                ...
                <form action="{{ url('storeSuperadminInspektorat') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <small style="color: red">password minimal 5 karakter</small>
                            </div>
                        </div>
                        <div class="form-group">
