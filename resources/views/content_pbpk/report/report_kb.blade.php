...
<table style="width: 100%">
    <tr>
        ...
        <td style="border-color: transparent;" align="center"><H1>KARTU BARANG </H1></td>
    </tr>
</table>
...
<div style="padding-top: 2%">
    ...
    <table>
        <tr>
            <td style="border-color: transparent; text-align: left;" width="100"><strong>Nama Barang</strong></td>
            <td style="border-color: transparent; text-align: left;" width="20">:</td>
            <td style="border-color: transparent; text-align: left;">{{ $barang->goods_name }}</td>

        </tr>
        <tr>
            <td style="border-color: transparent; text-align: left;" ><strong>Spesifikasi</strong></td>
            <td style="border-color: transparent; text-align: left;" >:</td>
            <td style="border-color: transparent; text-align: left;" >{{ $barang->specs }}</td>
        </tr>
    </table>
